        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="检验设备" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="checkDevice">
              <j-dict-select-tag type="list" v-model="model.checkDevice" dictCode="" placeholder="请选择检验设备" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/check/qzqmCheckingInfo/add",
          edit: "/check/qzqmCheckingInfo/edit",
          queryById: "/check/qzqmCheckingInfo/queryById"
        }
      }
    },
    computed: {
