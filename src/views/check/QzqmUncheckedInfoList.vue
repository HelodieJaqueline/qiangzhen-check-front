<template>
  <a-card :bordered="false">
    ...
    <qzqm-unchecked-info-modal ref="modalForm" @ok="modalFormOk"></qzqm-unchecked-info-modal>
  </a-card>
</template>
...
<script>
  ...
  import QzqmUncheckedInfoModal from './modules/QzqmUncheckedInfoModal'

  export default {
    name: 'QzqmUncheckedInfoList',
...
/*          {
        ...
        url: {
          list: "/check/qzqmCheckInfo/uncheckedList",
